	...
	<main class="main">
		<div class="container-fluid">
			<div class="row">
				...
				<!-- form -->
				<div class="col-12">
					<form action="{{ route('genre.store') }}" method="post"  role="form" enctype="multipart/form-data" class="sign__form sign__form--add">
                         @csrf
						...
						<div class="row">
								...
								<div class="row">
									<div class="col-12">
										<div class="sign__group">
											<input type="text" class="sign__input" id="" name="nama_genre" placeholder="Genre" required>
										</div>
									</div>
								</div>
							</div>
							<div class="col-12  d-flex justify-content gap-2">
								<button type="submit" class="sign__btn sign__btn--small">Publish</button>
								 <a href="{{ url('admin/genre') }}" class="sign__btn sign__btn--small">Back</a>
							</div>
						</div>
					</form>
				</div>
