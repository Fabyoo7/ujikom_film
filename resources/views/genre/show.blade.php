            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Detail Data genre</h4>
                                <form class="forms-sample" action="{{ route('genre.store') }}" method="post"
                                    ...
                                    <div class="form-group row">
                                        <label for="exampleInputUsername2"  class="col-sm-3 col-form-label ">Nama
                                            genre</label>
                                        <div class="col-sm-9">
                                            <input type="text" value="{{ $genre->nama_genre }}" disabled class="form-control" id="putih" name="nama_kategori" placeholder="Nama Kategori" required>
                                        </div>
                                    </div>
