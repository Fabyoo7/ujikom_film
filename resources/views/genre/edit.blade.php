	...
	<main class="main">
		<div class="container-fluid">
			<div class="row">
				...
				<!-- form -->
				<div class="col-12">
					<form action="{{ route('genre.update', $genre->id) }}" method="post"  role="form" enctype="multipart/form-data" class="sign__form sign__form--add">
                         @csrf
                         @method('PUT')
						<div class="row">
							<div class="col-12">
								<div class="row">
									<div class="col-12">
										<div class="sign__group">
											<input type="text" class="sign__input" id="" name="nama_genre" value="{{ $genre->nama_genre }}" required placeholder="Genre">
										</div>
									</div>
								</div>
							</div>
