                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ route('film.update', $film->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="sipnosis" id="putih" rows="4" required >{{ $film->sipnosis}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="putih" name="trailer"
                                                 value="{{ $film->trailer }}" required>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-primary mr-2">Submit</button>
                                    <a href="{{ url('admin/film') }}" class="btn btn-dark">Cancel</a><br>
