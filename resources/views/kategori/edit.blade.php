	...
	<main class="main">
		<div class="container-fluid">
			<div class="row">
				...
				<!-- form -->
				<div class="col-12">
					<form action="{{ route('kategori.update', $kategori->id) }}" method="post"  role="form" enctype="multipart/form-data" class="sign__form sign__form--add">
                         @csrf
                         @method('PUT')
						<div class="row">
							<div class="col-12">
								<div class="row">
									<div class="col-12">
										<div class="sign__group">
											<input type="text" class="sign__input" id="" name="nama_kategori" value="{{ $kategori->nama_kategori }}" required placeholder="Kategori">
										</div>
									</div>
								</div>
							</div>
